<div align="center">
  ...
  <p> Frontend developer с опытом работы в полтора года, год из которых ушел на коммерческую разработку. В основном занимался разработкой внутренних CRM систем в сфере авто бизнеса и финтех. Рефакторинг чужого кода, написание UI компонентов. Работал над посадочными страницами компании или заказчиков.
Попробовал как работу в офисе, так и удаленную работу.
Так же есть опыт написания собственного API на NodeJs и Golang для своих нужд.
В свободное время увлекаюсь настольными играми 🤗.
</p>
...
<div>
  ...
  <div>
    <img src="https://img.shields.io/badge/Youtrack-A100FF?style=for-the-badge&logo=JetBrains&logoColor=white"/>
...
[STOCRM](https://stocrm.ru/) - CRM System для автомобильного бизнеса. Большое кол-во интеграций и внутреннего функционала.
